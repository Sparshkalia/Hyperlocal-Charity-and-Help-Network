...
export default function login_add_new_user() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await addNewUser(formData.username, formData.password, formData.email, formData.fullName);
      router.push('/signup'); 
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <Head>
        ...
        <meta name="description" content="Join our community today" />
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  autoComplete="name"
                  required
                  className="appearance-none block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out sm:text-sm"
